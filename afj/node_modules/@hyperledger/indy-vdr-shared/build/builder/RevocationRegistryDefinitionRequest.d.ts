...
export declare class RevocationRegistryDefinitionRequest extends IndyVdrRequest<RevocationRegistryDefinitionResponse> {
    constructor(options: RevocationRegistryDefinitionRequestOptions);
}
export {};
