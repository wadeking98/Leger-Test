...
export declare type NativeCredentialEntry = {
    credential: ObjectHandle;
    timestamp?: number;
    revocationState?: ObjectHandle;
};
export declare type NativeCredentialProve = {
    entryIndex: number;
    referent: string;
    isPredicate: boolean;
    reveal: boolean;
};
export declare type NativeNonRevokedIntervalOverride = {
    revocationRegistryDefinitionId: string;
    requestedFromTimestamp: number;
    overrideRevocationStatusListTimestamp: number;
};
export declare type NativeRevocationEntry = {
    revocationRegistryDefinitionEntryIndex: number;
    entry: ObjectHandle;
    timestamp: number;
};
export declare type NativeCredentialRevocationConfig = {
