...
import type { AgentContext, AgentMessage, DependencyManager, FeatureRegistry, CredentialProtocolOptions, InboundMessageContext, ProblemReportMessage, ExtractCredentialFormats, CredentialProtocol } from '@aries-framework/core';
import { CredentialExchangeRecord, BaseCredentialProtocol } from '@aries-framework/core';
...
export declare class V1CredentialProtocol extends BaseCredentialProtocol<[LegacyIndyCredentialFormatService]> implements CredentialProtocol<[LegacyIndyCredentialFormatService]> {
     ...
     *
     */
    createProblemReport(agentContext: AgentContext, { credentialRecord, description }: CredentialProtocolOptions.CreateCredentialProblemReportOptions): Promise<CredentialProtocolOptions.CredentialProtocolMsgReturnType<ProblemReportMessage>>;
