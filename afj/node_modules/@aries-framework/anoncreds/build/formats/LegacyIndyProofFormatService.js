...
class LegacyIndyProofFormatService {
    ...
    async getRevocationStatus(agentContext, proofRequest, requestedItem, credentialInfo) {
        ...
        const revocationStatusResult = await registry.getRevocationStatusList(agentContext, revocationRegistryId, (_b = requestNonRevoked.to) !== null && _b !== void 0 ? _b : Date.now());
